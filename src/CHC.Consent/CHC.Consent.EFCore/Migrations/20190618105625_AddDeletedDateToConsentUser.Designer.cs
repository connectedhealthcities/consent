...
namespace CHC.Consent.EFCore.Migrations
{
    ...
    [Migration("20190618105625_AddDeletedDateToConsentUser")]
    partial class AddDeletedDateToConsentUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CHC.Consent.EFCore.Consent.EvidenceDefinitionEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CHC.Consent.EFCore.Entities.AgencyEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CHC.Consent.EFCore.Entities.AgencyFieldEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CHC.Consent.EFCore.Entities.AuthorityEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CHC.Consent.EFCore.Identity.IdentifierDefinitionEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("IdentifierDefinition");
                });

            modelBuilder.Entity("CHC.Consent.EFCore.Identity.PersonAgencyId", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("AgencyId", "SpecificId")
                        .IsUnique();

                    b.ToTable("PersonAgencyId");
                });
            ...
            modelBuilder.Entity("CHC.Consent.EFCore.Entities.AgencyFieldEntity", b =>
                {
                    b.HasOne("CHC.Consent.EFCore.Entities.AgencyEntity", "Agency")
                        .WithMany("Fields")
                        .HasForeignKey("AgencyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CHC.Consent.EFCore.Identity.IdentifierDefinitionEntity", "Identifier")
                        .WithMany()
                        .HasForeignKey("IdentifierDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("CHC.Consent.EFCore.Entities.PersonIdentifierEntity", b =>
                {
                    b.HasOne("CHC.Consent.EFCore.Entities.AuthorityEntity", "Authority")
                        .WithMany()
            ...
            modelBuilder.Entity("CHC.Consent.EFCore.Identity.PersonAgencyId", b =>
                {
                    b.HasOne("CHC.Consent.EFCore.Entities.AgencyEntity")
                        .WithMany()
                        .HasForeignKey("AgencyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CHC.Consent.EFCore.Entities.PersonEntity")
                        .WithMany()
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
