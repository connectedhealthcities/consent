...
namespace CHC.Consent.Api.Client.Models
{
    ...
    public partial class PersonSpecification
    {
        ...
        /// Initializes a new instance of the PersonSpecification class.
        /// </summary>
        public PersonSpecification(IList<IIdentifier> identifiers = default(IList<IIdentifier>), IList<MatchSpecification> matchSpecifications = default(IList<MatchSpecification>))
        {
        ...
        public IList<IIdentifier> Identifiers { get; set; }
